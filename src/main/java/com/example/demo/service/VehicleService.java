...
public interface VehicleService {
    ...
    ResultBean queryVehicle(String plateNo,int page,int rows);
    ...
    List<Vehicle> findByIsDeleteAndOrgNameAndPlateNoAndOperator(int status,String orgName,String plateNo,String operator);
